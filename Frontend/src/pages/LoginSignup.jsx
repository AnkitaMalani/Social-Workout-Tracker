...
const LoginSignup = () => {
  ...
  return (
    <div className="bg-[#121212] text-white min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md bg-[#1a1a1a] rounded-lg p-6 sm:p-8 shadow-lg">
        <h2 className="text-center text-2xl sm:text-3xl font-bold text-white mb-5 sm:mb-8">Sign in</h2>
        <form className="space-y-6 sm:space-y-6" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              value={email}
              required
              className="block w-full bg-[#1a1a1a] rounded-lg p-3 md:p-2 text-white border border-gray-600 placeholder-gray-500 focus:border-[#F2AB40] focus:outline-none transition-colors"
